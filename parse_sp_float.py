...
def parse_hex(hexstring, bias=127, float_format='%.6e', no_decimal=False):
...
def main(argv=None):
    ...
    if argv is None:
        ...
        arg_parser.add_option(
          '--bias', action='store', dest='bias', default=127, 
          help="Exponent bias of the floating point model (default=127)")
        arg_parser.add_option(
